...
import { TwitchReactionsService } from './reactions/twitch-reactions.service';
...
@Module({
  ...
  providers: [TwitchService, TwitchReactionsService],
  exports: [TwitchService, TwitchReactionsService],
})
