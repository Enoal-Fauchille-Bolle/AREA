...
import { YouTubeOAuth2Service } from './youtube-oauth2.service';

// Mock fetch globally
global.fetch = jest.fn();

describe('YouTubeOAuth2Service', () => {
  let service: YouTubeOAuth2Service;
  ...
  beforeEach(async () => {
    ...
    service = module.get<YouTubeOAuth2Service>(YouTubeOAuth2Service);
  });
  ...
  describe('exchangeCodeForTokens', () => {
    ...
    it('should throw error when OAuth2 is not configured', async () => {
      mockConfigService.get.mockReturnValue({
        oauth2: { youtube: { clientId: undefined, clientSecret: undefined } },
      });

      const newService = new YouTubeOAuth2Service(mockConfigService);
      ...
      ).rejects.toThrow('YouTube OAuth2 is not properly configured');
    });
  ...
  describe('Configuration', () => {
    it('should handle missing app config', () => {
      ...
      expect(() => new YouTubeOAuth2Service(mockConfigService)).toThrow(
    ...
    it('should load configuration successfully', () => {
      ...
      expect(() => new YouTubeOAuth2Service(mockConfigService)).not.toThrow();
    });
  });
});
