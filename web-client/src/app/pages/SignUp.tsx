...
function SignUp() {
  ...
  const handleGitHubSignUp = () => {
    githubOAuth.initiate('register');
  };

  const handleDiscordSignUp = () => {
    discordOAuth.initiate('register');
  };
        ...
        <div className="bg-white rounded-2xl p-12 shadow-2xl max-w-md w-full mx-4">
          ...
          <div className="mt-8">
            ...
            <button
              ...
              type="button"
              disabled={isLoading}
              className="w-full mt-4 bg-gray-800 border-2 border-gray-800 text-white py-4 rounded-lg text-lg font-bold hover:bg-gray-900 hover:border-gray-900 hover:scale-105 transform transition-all duration-300 flex items-center justify-center space-x-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
            ...
            <button
              ...
              type="button"
              disabled={isLoading}
              className="w-full mt-4 bg-indigo-600 border-2 border-indigo-600 text-white py-4 rounded-lg text-lg font-bold hover:bg-indigo-700 hover:border-indigo-700 hover:scale-105 transform transition-all duration-300 flex items-center justify-center space-x-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
