...
class TwitchOAuthService {
  ...
  static Future<String> _buildAuthUrl({required bool forService}) async {
    ...
    final params = {
      ...
      'response_type': 'code',
      'scope': scope,
      'state': forService ? 'service-twitch' : 'twitch',
    };
    ...
    return Navigator.of(context).push<String>(
      MaterialPageRoute(
        ...
        builder: (context) => _OAuthWebView(
            authUrl: authUrl, forService: forService, providerName: 'Twitch'),
      ),
    );
  }
}

// Reuse same webview widget logic as Google to keep behavior consistent
